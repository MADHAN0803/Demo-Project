...
@CucumberOptions(snippets = SnippetType.CAMELCASE, dryRun = true, plugin = { "pretty",
		"json:target/API.json" }, monochrome = true, features = "src\\test\\resources", glue = { "com.stepdefinition" })
